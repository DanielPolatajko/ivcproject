import sys
sys.path.append("C:\Data_Science\Machine Learning Practical, MLP\Coursework\mlpractical-mlp2019-20-coursework_2") # go to parent dir
...
elif args.block_type == 'res_block':
    processing_block_type = ResidualProcessingBlock
    dim_reduction_block_type = ResidualDimensionalityReductionBlock
elif args.block_type == 'resbn_block':
    processing_block_type = ResidualBNProcessingBlock
    dim_reduction_block_type = ResidualBNDimensionalityReductionBlock
